        ...
        <Col md={6}>
          <Form style={{ padding: "20px" }}>
            <Form.Group controlId="name">
              ...
              <Form.Control className="my-2" type="name" style={{ width: "70%" }} placeholder="Enter type of expenses"></Form.Control>
            </Form.Group>
            <Button className="my-3" onClick={() => dispatch(addExpense(amount))}>
              Add Expenses
            </Button>
          </Form>
        </Col>
